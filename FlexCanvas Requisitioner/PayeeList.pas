...
begin
  With AcctData do
    begin
    if FlexAccountMainMenuForm.MyNoteBook.ActivePage = FlexAccountMainMenuForm.TabJournalVoucher then
      begin
      ...
      CanvassDatarvPCode.Text := PayeePCode.Text;
      CanvassDatarvName.Text  := PayeeName.Text;
      Payee.Close;
      FlexAccountMainMenuForm.DBMemo3.SetFocus;
      close;
       end;
    end;
end;
...
begin
  Try
   Acctdata.Payeeschedgroup.TEXT     := '0';
   AcctData.Payee.Post;
